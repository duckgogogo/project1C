    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header navbar-defalt">
          <a class="navbar-brand" href="http://oak.cs.ucla.edu/classes/cs143/project/demo/p1c/index.php">CS143 DataBase Query System (Demo)</a>
        </div>
      </div>
    </nav>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="http://oak.cs.ucla.edu/classes/cs143/project/demo/p1c/Show_A.php">Show Actor Information</a></li>
            <li><a href="http://oak.cs.ucla.edu/classes/cs143/project/demo/p1c/Show_M.php">Show Movie Information</a></li>
          </ul>
          <ul class="nav nav-sidebar">
